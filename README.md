...
Проект завершён в рамках дипломной работы курса «Java-разработчик» в Skypro.  
Дипломная работа успешно защищена.

Проект демонстрирует реализацию backend-части сервиса объявлений: регистрацию и авторизацию пользователей, работу с объявлениями, комментариями, ролями пользователей, базой данных и изображениями.
